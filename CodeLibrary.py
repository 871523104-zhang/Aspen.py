...
#This just shortens the path you need to call for Streams and Blocks
    ...
    def GLB(self):
        ...
        定义节点路径
        """
        return self.AspenSimulation.Tree.Elements("Data")
    ...
    def FUME(self):
        ...
        定义节点路径
        """
        return self.AspenSimulation.Tree.Elements("Data").Elements("Streams").Elements("FLUE-GAS").Elements("Input")
...
#POWERFUNCTION for Running the Simulation:
    ...
    def EngineRun(self) -> None:
        ...
        self.ExportReportFile("TutorialReportFile")
...
###GLOBAL
    def GLB_Set_Method(self, method: str):
        self.GLB.Elements("Properties").Elements("Specifications").Elements("Input").Elements("GBASEOPSET").Value = method

###fume
    def FUME_Set_Temperature(self, fume_Temperature):
        self.FUME.Elements("TEMP").Elements("MIXED").Value = fume_Temperature

    def FUME_Set_Pressure(self, fume_Pressure):
        self.FUME.Elements("PRES").Elements("MIXED").Value = fume_Pressure

    def FUME_Set_Total_Flow_Rate(self, total_flow_rate):
        self.FUME.Elements("TOTFLOW").Elements("MIXED").Value = total_flow_rate

    def FUME_Set_H2O(self, fume_H2O):
        self.FUME.Elements("FLOW").Elements("MIXED").Elements("H2O").Value = fume_H2O

    def FUME_Set_N2(self, fume_N2):
        self.FUME.Elements("FLOW").Elements("MIXED").Elements("N2").Value = fume_N2

    def FUME_Set_CO2(self, fume_CO2):
        self.FUME.Elements("FLOW").Elements("MIXED").Elements("CO2").Value = fume_CO2

    def FUME_Set_O2(self, fume_O2):
        self.FUME.Elements("FLOW").Elements("MIXED").Elements("O2").Value = fume_O2

###cold source
    def COLDSOURCE_Set_Temperature(self, coldsource_Temperature):
        self.COLDSOURCE.Elements("TEMP").Elements("MIXED").Value = coldsource_Temperature
    def COLDSOURCE_Set_Pressure(self, coldsource_Pressure):
...
#Page 2         Flash Option
    ...
    def BLK_CISTR_GET_ME_ALL_INPUTS_BACK(self, Blockname:str): #-> Dict[str, Union[str,float,int]]
        ...
        # 新增变量
        Property_Method = self.BLK.Elements(Blockname).Elements("Input").Elements("OPSETNAME").Value
...
#############   OUTPUTS
    ...
    #def GLB_GET_OUTPUTS(self) -> Dict[str, Union[str,float,int]]:
