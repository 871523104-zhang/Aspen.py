...
sim = Simulation(AspenFileName= "AspenTutorial.bkp", WorkingDirectoryPath= r"F:\AspenPlus-Python-Interface-main\AspenPlus-Python-Interface-main\CaseExamplesAndTutorials" ,VISIBILITY=True)
...
#2. CISTR input summary（显示可以编辑的输入变量）
...
#4. Output Summary for RPLUG（获得模拟结果）
